<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Jumlah Transaksi Valid Pelanggan') }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h1 class="text-xl font-bold mb-4">Daftar Pelanggan dan Jumlah Transaksi Valid</h1>

                    <!-- Form Pencarian -->
                    <div class="mb-4">
                        <form method="GET" action="{{ route('jumlah.transaksi.valid') }}" class="flex items-center">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse($pelanggans as $pelanggan)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                            {{ $pelanggan->jumlah_transaksi_valid }}
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
