<nav x-data="{ open: false }" >
    ...
    <div class=" max-w-9xl mx-auto px-4 sm:px-6 lg:px-8 bg-sky-700">
        <div class="flex justify-between h-16">
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <!-- Tambahkan @click="open = ! open" untuk mengembalikan fungsi toggle -->
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden"> 
        <div class="pt-2 pb-3 space-y-1 bg-sky-700">
            ...
            <!-- Link Responsive untuk Input Nomor Transaksi -->
            @if(Auth::check() && Auth::user()->isPelanggan())
            ...
            @if(Auth::check() && Auth::user()->isKaryawan())
                <!-- Ganti route dari 'karyawan.pelanggan.index' menjadi 'dashboard.karyawan' -->
